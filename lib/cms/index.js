...
var gm = require('gm');
//settings
var db = mongoose.createConnection('127.0.0.1','rol');
...
function addRoutes(){
	...
	app.get(url + '/components', function(req, res){
		res.render(app_settings.views + 'components');
	});
	app.get(url + '/pages', function(req, res){
		res.render(app_settings.views + 'pages');
	});
